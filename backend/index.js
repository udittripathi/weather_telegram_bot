...
app.use((req, res, next) => {
  res.header('Access-Control-Allow-Origin', 'https://weather-telegram-bot-frontend.vercel.app');
...
bot.start((ctx) => {
    ...
    ctx.reply('Welcome to the WEATHER UPDATE bot!\nThis is a publicly available bot made by Udit to get the weather information of a particular city of your choice... \n\n\nTap /help - To Get help with commands\n\nMade with ❤️ by Udit');
});
